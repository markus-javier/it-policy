...
1.  **Request Initiation:** Employee or manager submits formal access
    > request
...
**Executive ACCOUNTANT Level: This group comprises the Executive and
Financial Authority responsible for primary decision-making,
...
-   Board Members: Governance oversight and strategic information access

-   General Manager: Full operational access with executive reporting
...
-   Department Heads: Full departmental access with cross-functional
  ...
  Group                 Role
  --------------------- -------------------------------------------------
  BOD                   Governance oversight and strategic information
                        access

  Executive             CEO, COO. Operational
...
-   Supervisors: Team management with departmental operational access

-   Team Leads: Project coordination with limited administrative rights
...
-   Loan Officers: Credit assessment and loan processing capabilities
...
|            | Data**     | Systems**      | Systems**  | Tools**     |
+============+============+================+============+=============+
| Board      | Summary    | Financial      | No Access  | All Reports |
| Member     | Only       | Reports        |            |             |
+------------+------------+----------------+------------+-------------+
| General    |            |                | Read       | All Reports |
| Manager    |            |                | Access     |             |
|            |            |                |            |   -         |
|            |            |                |            | ----------- |
|            |            |                |            | ----------- |
...
|            |            |                |            | ###         |
+------------+------------+----------------+------------+-------------+
| Branch     |            |                | No Access  | Branch      |
| Manager    |            |                |            | Reports     |
+------------+------------+----------------+------------+-------------+
| Teller     | Customer   | Transaction    | No Access  | Daily       |
|            | Service    | Processing     |            | Reports     |
+------------+------------+----------------+------------+-------------+
| ICT        | Admin      | System Admin   | Full       | Technical   |
| Manager    | Access     |                | Access     | Reports     |
+------------+------------+----------------+------------+-------------+

### **5.3 Privileged Access Management**

#### **5.3.1 Privileged Account Types**
...
#### **5.3.2 Privileged Access Controls**
...
### **5.4 Access Review and Certification**

#### **5.4.1 Regular Access Reviews**
...
#### **5.4.2 Access Recertification Process**
